...
/* p_db.c */
void copyobj(dbref player, dbref old, dbref new);
...
void add_prop_nofetch(dbref player, const char *type, const char *class, int value);
void add_property(dbref player, const char *type, const char *class, int value);
...
int has_property(dbref player, dbref what, const char *type, const char *class, int value);
int has_property_strict(dbref player, dbref what, const char *type, const char *class, int value);
...
struct boolexp *get_property_lock(dbref player, const char *class);
